            ...
            <main id='lesson-container' className={classes.content}>
                ...
                {!isPdf && (
                    <div className="Courses-container video-conatiner">
                        ...
                        >
                            <iframe title='moderator-frame' frameborder="0" width="100%" height="100%" src={"https://geo.dailymotion.com/player/xry4k.html?video=" + link} allowfullscreen allow="autoplay; fullscreen; picture-in-picture"></iframe>
                        </div>
                    </div>
                )}
            </main>
