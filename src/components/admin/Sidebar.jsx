...
import Students from '../../assets/admin/social-group.svg';
import Teachers from '../../assets/admin/man.svg';
import Courses from '../../assets/admin/draft.svg';
import adminProfile from '../../assets/admin/settings.svg';
            ...
            <SidebarContainer className="side-bar-to-left">
                ...
                <SlickBar clicked={click} className="side-bar-to-right">
                    ...
                    >
                        ...
                        <Text clicked={click}>
                            <img src={Students} alt="Students" className='side-bar-hidden-logo' />
                            الطلاب
                        </Text>
                    </Item>
                    <Item
                    ...
                    >
                        ...
                        <Text clicked={click}>
                            <img
                                className='side-bar-hidden-logo'
                                src={Teachers}
                                alt="teachers"
                                style={{
                                    height: '25px',
